...
<div class="login_box">
	...
	<div class="login_right">
		...
		<div class="login_form">
			...
			<?php if($admin_verify) : ?>
			<li><label><?php echo L('verify');?>:</label><input name="verifyCode" class="input-text inputbox"  id="verifyCode"  size="6" value="" maxlength="4" /><img src="<?php echo U('Home/Index/verify');?>" onclick="javascript:resetVerifyCode();" class="checkcode" align="absmiddle"  title="<?php echo L('resetVerifyCode');?>" id="verifyImage"/></li><?php endif;?>
