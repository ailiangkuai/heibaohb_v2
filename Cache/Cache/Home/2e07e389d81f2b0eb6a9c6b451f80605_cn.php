	...
	<TR valign="top">
		...
		<table align="center" cellpadding="0" cellspacing="0" border="0" width="680">
			...
			<?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($k % 2 );++$k;?><tr>
					<td height="24">&nbsp;<img src="/Public/Image/dot_1003.gif">&nbsp; <font style="font-size:12px; color:#666666;"><?php echo (todate($r["createtime"],'Y-m-d')); ?>
						| </font><a href="<?php echo ($r["url"]); ?>" class="top3" target="_blank"><?php echo ($r["title"]); ?></a></td>
				</tr>
				<tr>
					<td height="8" background="/Public/Image/dot_1004.gif"></td>
				</tr>
				<?php if($k%6==0): ?>
				<tr>
					<td></td>
