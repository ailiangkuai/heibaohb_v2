...
<table align="center" cellpadding="0" cellspacing="0" border="0" width="1000" background="/Public/Image/in_2022.png">
	<TR valign="top">
		...
		<table align="center" cellpadding="0" cellspacing="0" border="0" width="680">
			<tbody><tr><td height="45" colspan="7" style="color:#FF0000; font-family:'黑体'; font-size:16px;">&nbsp;下载文件如果不能正常下载阅览，请下载并安装PDF Reader软件。 <a href="/Public/Image/install_reader10_cn_aih.exe"><img src="/Public/Image/ad_1001.jpg" border="0" align="absmiddle"></a></td></tr>
			<tr bgcolor="#abacaf" style="color:#FFFFFF; font-weight:bold;">
				<td width="374" height="30">&nbsp; 信息标题</td>
				<td><img src="/Public/Image/in_5043.gif"></td><td width="90" align="center">&nbsp; 文件大小</td>
				<td><img src="/Public/Image/in_5043.gif"></td><td width="120" align="center">&nbsp; 更新日期</td>
				<td><img src="/Public/Image/in_5043.gif"></td><td width="90" align="center">下载</td></tr>
			</tbody></table>
		<table align="center" cellpadding="0" cellspacing="0" border="0" width="680">
			<tbody>
			<?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($k % 2 );++$k;?><tr>
				<td width="380" height="5"></td>
				<td width="90"></td>
				<td width="120"></td>
				<td width="90"></td>
			</tr>
			<tr>
				<td height="32">&nbsp;<img src="/Public/Image/dot_1003.gif">&nbsp; <a
						href="__ROOT__/index.php?m=Download&a=down&id=<?php echo ($r["id"]); ?>" class="top3"
						target="_blank"><?php echo ($r["title"]); ?></a></td>
				<td style="color:#666666;">&nbsp; 61Kb</td>
				<td align="center" style="color:#666666;"><?php echo (todate($r["createtime"],'Y-m-d')); ?></td>
				<td align="center">[<a href="__ROOT__/index.php?m=Download&a=down&id=<?php echo ($r["id"]); ?>"
									   class="top5" target="_blank">点击下载</a>]
				</td>
			</tr>
			<tr>
				<td colspan="4" height="8" background="/Public/Image/line_101.gif"></td>
