	...
	function delete(){
		...
		if (isset ( $id )) {
			if(false!==$model->delete($id)){
				...
				$jumpUrl = $_POST['forward'] ? $_POST['forward'] : U(MODULE_NAME.'/index');//by yyf
				$this->assign ( 'jumpUrl', $jumpUrl);//by yyf
