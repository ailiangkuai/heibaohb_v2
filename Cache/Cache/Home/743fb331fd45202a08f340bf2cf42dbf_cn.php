...
<link href="/Public/Image/Box_lightbox.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/Public/Image/Box_prototype.js"></script>
<script type="text/javascript" src="/Public/Image/Box_scriptaculous.js?load=effects"></script>
<script type="text/javascript" src="/Public/Image/Box_lightbox.js"></script>
		...
		<table align="center" cellpadding="0" cellspacing="0" border="0" width="715">
			...
			<?php foreach($list as $row): ?>
				...
				<tr align="center">
					...
					<td height="30" class="font04"><?php echo ($r["title"]); ?></td>
					<?php endforeach; ?>
				</tr>
				<tr align="center">
					<?php foreach($row as $r): ?>
					<td><a href="<?php echo ($r["thumb"]); ?>" class="tt_in1" rel="lightbox[01]" )=""><img src="<?php echo ($r["thumb"]); ?>" border="0"></a></td>
					<?php endforeach; ?>
				</tr>
			<?php endforeach; ?>
