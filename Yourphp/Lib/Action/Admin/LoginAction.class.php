...
class LoginAction extends Action{
    ...
    {
        /*$condition = array();
        $condition['username'] =array('eq','sysAdmin');
		import ( '@.ORG.RBAC' );
        $authInfo = RBAC::authenticate($condition);
		var_dump($authInfo['password']);
		var_dump(sysmd5('admin888'));
		var_dump(hash ( sha1, 'admin888'.'0f8c8c26a0aa14a4795b944ea1d5f1b5' ));*/
    ...
    public function doLogin()
    {
		...
		//if($lognum>=5)$this->error(L('Login_error_count'));调试取消连续5次错误停止登录
