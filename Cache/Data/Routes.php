...
'/^(cn|en)\/([\w^_]+)\/show\/(\d+)_(\d+).html$/' => 'Urlrule/show?l=:1&catdir=:2&id=:3&p=:4&',
'/^([\w^_]+)\/show\/(\d+)_(\d+).html$/' => 'Urlrule/show?catdir=:1&id=:2&p=:3&',
'/^(cn|en)\/([\w^_]+)\/show\/(\d+).html$/' => 'Urlrule/show?l=:1&catdir=:2&id=:3&',
'/^([\w^_]+)\/show\/(\d+).html$/' => 'Urlrule/show?catdir=:1&id=:2&',
'/^(cn|en)\/([\w^_]+)\/(\d+).html$/' => 'Urlrule/index?l=:1&catdir=:2&p=:3&',
'/^([\w^_]+)\/(\d+).html$/' => 'Urlrule/index?catdir=:1&p=:2&',
